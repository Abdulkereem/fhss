...
def logger(userid):
    ...
    New_histories = Histories(Hospital_Name=current_user.hospital_name, Hospital_ID=current_user.id,Patient_name=user.first_name,Patient_nin=user.nin,Patient_fhss=user.fhss)
...
@health_care_provider.route('/eprofile/<int:id>')
@login_required
